 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(e){function t(N,H){var F=N.length;N.push(H);t:for(;0<F;){var q=F-1>>>1,tt=N[q];if(0<a(tt,H))N[q]=H,N[F]=tt,F=q;else break t}}function n(N){return N.length===0?null:N[0]}function i(N){if(N.length===0)return null;var H=N[0],F=N.pop();if(F!==H){N[0]=F;t:for(var q=0,tt=N.length,st=tt>>>1;q<st;){var at=2*(q+1)-1,mt=N[at],_t=at+1,Bt=N[_t];if(0>a(mt,F))_t<tt&&0>a(Bt,mt)?(N[q]=Bt,N[_t]=F,q=_t):(N[q]=mt,N[at]=F,q=at);else if(_t<tt&&0>a(Bt,F))N[q]=Bt,N[_t]=F,q=_t;else break t}}return H}function a(N,H){var F=N.sortIndex-H.sortIndex;return F!==0?F:N.id-H.id}if(e.unstable_now=void 0,typeof performance=="object"&&typeof performance.now=="function"){var s=performance;e.unstable_now=function(){return s.now()}}else{var r=Date,o=r.now();e.unstable_now=function(){return r.now()-o}}var l=[],c=[],f=1,d=null,h=3,p=!1,m=!1,v=!1,x=!1,u=typeof setTimeout=="function"?setTimeout:null,g=typeof clearTimeout=="function"?clearTimeout:null,_=typeof setImmediate<"u"?setImmediate:null;function y(N){for(var H=n(c);H!==null;){if(H.callback===null)i(c);else if(H.startTime<=N)i(c),H.sortIndex=H.expirationTime,t(l,H);else break;H=n(c)}}function C(N){if(v=!1,y(N),!m)if(n(l)!==null)m=!0,T||(T=!0,I());else{var H=n(c);H!==null&&Y(C,H.startTime-N)}}var T=!1,A=-1,L=5,E=-1;function M(){return x?!0:!(e.unstable_now()-E<L)}function U(){if(x=!1,T){var N=e.unstable_now();E=N;var H=!0;try{t:{m=!1,v&&(v=!1,g(A),A=-1),p=!0;var F=h;try{e:{for(y(N),d=n(l);d!==null&&!(d.expirationTime>N&&M());){var q=d.callback;if(typeof q=="function"){d.callback=null,h=d.priorityLevel;var tt=q(d.expirationTime<=N);if(N=e.unstable_now(),typeof tt=="function"){d.callback=tt,y(N),H=!0;break e}d===n(l)&&i(l),y(N)}else i(l);d=n(l)}if(d!==null)H=!0;else{var st=n(c);st!==null&&Y(C,st.startTime-N),H=!1}}break t}finally{d=null,h=F,p=!1}H=void 0}}finally{H?I():T=!1}}}var I;if(typeof _=="function")I=function(){_(U)};else if(typeof MessageChannel<"u"){var k=new MessageChannel,Z=k.port2;k.port1.onmessage=U,I=function(){Z.postMessage(null)}}else I=function(){u(U,0)};function Y(N,H){A=u(function(){N(e.unstable_now())},H)}e.unstable_IdlePriority=5,e.unstable_ImmediatePriority=1,e.unstable_LowPriority=4,e.unstable_NormalPriority=3,e.unstable_Profiling=null,e.unstable_UserBlockingPriority=2,e.unstable_cancelCallback=function(N){N.callback=null},e.unstable_forceFrameRate=function(N){0>N||125<N?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):L=0<N?Math.floor(1e3/N):5},e.unstable_getCurrentPriorityLevel=function(){return h},e.unstable_next=function(N){switch(h){case 1:case 2:case 3:var H=3;break;default:H=h}var F=h;h=H;try{return N()}finally{h=F}},e.unstable_requestPaint=function(){x=!0},e.unstable_runWithPriority=function(N,H){switch(N){case 1:case 2:case 3:case 4:case 5:break;default:N=3}var F=h;h=N;try{return H()}finally{h=F}},e.unstable_scheduleCallback=function(N,H,F){var q=e.unstable_now();switch(typeof F=="object"&&F!==null?(F=F.delay,F=typeof F=="number"&&0<F?q+F:q):F=q,N){case 1:var tt=-1;break;case 2:tt=250;break;case 5:tt=1073741823;break;case 4:tt=1e4;break;default:tt=5e3}return tt=F+tt,N={id:f++,callback:H,priorityLevel:N,startTime:F,expirationTime:tt,sortIndex:-1},F>q?(N.sortIndex=F,t(c,N),n(l)===null&&N===n(c)&&(v?(g(A),A=-1):v=!0,Y(C,F-q))):(N.sortIndex=tt,t(l,N),m||p||(m=!0,T||(T=!0,I()))),N},e.unstable_shouldYield=M,e.unstable_wrapCallback=function(N){var H=h;return function(){var F=h;h=H;try{return N.apply(this,arguments)}finally{h=F}}}})(Vx);Gx.exports=Vx;var DS=Gx.exports,kx={exports:{}},Gt={};/**
 * @license React
 * react.production.js
 *
 * Copyright (c) Meta Platforms, Inc. and affiliates.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const zb=bt.forwardRef(({color:e="currentColor",size:t=24,strokeWidth:n=2,absoluteStrokeWidth:i,className:a="",children:s,iconNode:r,...o},l)=>bt.createElement("svg",{ref:l,...Pb,width:t,height:t,stroke:e,strokeWidth:i?Number(n)*24/Number(t):n,className:Hv("lucide",a),...!s&&!Ob(o)&&{"aria-hidden":"true"},...o},[...r.map(([c,f])=>bt.createElement(c,f)),...Array.isArray(s)?s:[s]]));/**
 * @license lucide-react v0.562.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const bs=(e,t)=>{const n=bt.forwardRef(({className:i,...a},s)=>bt.createElement(zb,{ref:s,iconNode:t,className:Hv(`lucide-${Lb(Em(e))}`,`lucide-${e}`,i),...a}));return n.displayName=Em(e),n};/**
 * @license lucide-react v0.562.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
...
}`;function fR(e,t,n){let i=new cS;const a=new Xt,s=new Xt,r=new ze,o=new PE({depthPacking:L1}),l=new zE,c={},f=n.maxTextureSize,d={[Ha]:bn,[bn]:Ha,[Ii]:Ii},h=new ia({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new Xt},radius:{value:4}},vertexShader:cR,fragmentShader:uR}),p=h.clone();p.defines.HORIZONTAL_PASS=1;const m=new An;m.setAttribute("position",new Mi(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const v=new Vn(m,h),x=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=kv;let u=this.type;this.render=function(T,A,L){if(x.enabled===!1||x.autoUpdate===!1&&x.needsUpdate===!1||T.length===0)return;const E=e.getRenderTarget(),M=e.getActiveCubeFace(),U=e.getActiveMipmapLevel(),I=e.state;I.setBlending(ji),I.buffers.depth.getReversed()===!0?I.buffers.color.setClear(0,0,0,0):I.buffers.color.setClear(1,1,1,1),I.buffers.depth.setTest(!0),I.setScissorTest(!1);const k=u!==zi&&this.type===zi,Z=u===zi&&this.type!==zi;for(let Y=0,N=T.length;Y<N;Y++){const H=T[Y],F=H.shadow;if(F===void 0){Ft("WebGLShadowMap:",H,"has no shadow.");continue}if(F.autoUpdate===!1&&F.needsUpdate===!1)continue;a.copy(F.mapSize);const q=F.getFrameExtents();if(a.multiply(q),s.copy(F.mapSize),(a.x>f||a.y>f)&&(a.x>f&&(s.x=Math.floor(f/q.x),a.x=s.x*q.x,F.mapSize.x=s.x),a.y>f&&(s.y=Math.floor(f/q.y),a.y=s.y*q.y,F.mapSize.y=s.y)),F.map===null||k===!0||Z===!0){const st=this.type!==zi?{minFilter:In,magFilter:In}:{};F.map!==null&&F.map.dispose(),F.map=new gs(a.x,a.y,st),F.map.texture.name=H.name+".shadowMap",F.camera.updateProjectionMatrix()}e.setRenderTarget(F.map),e.clear();const tt=F.getViewportCount();for(let st=0;st<tt;st++){const at=F.getViewport(st);r.set(s.x*at.x,s.y*at.y,s.x*at.z,s.y*at.w),I.viewport(r),F.updateMatrices(H,st),i=F.getFrustum(),y(A,L,F.camera,H,this.type)}F.isPointLightShadow!==!0&&this.type===zi&&g(F,L),F.needsUpdate=!1}u=this.type,x.needsUpdate=!1,e.setRenderTarget(E,M,U)};function g(T,A){const L=t.update(v);h.defines.VSM_SAMPLES!==T.blurSamples&&(h.defines.VSM_SAMPLES=T.blurSamples,p.defines.VSM_SAMPLES=T.blurSamples,h.needsUpdate=!0,p.needsUpdate=!0),T.mapPass===null&&(T.mapPass=new gs(a.x,a.y)),h.uniforms.shadow_pass.value=T.map.texture,h.uniforms.resolution.value=T.mapSize,h.uniforms.radius.value=T.radius,e.setRenderTarget(T.mapPass),e.clear(),e.renderBufferDirect(A,null,L,h,v,null),p.uniforms.shadow_pass.value=T.mapPass.texture,p.uniforms.resolution.value=T.mapSize,p.uniforms.radius.value=T.radius,e.setRenderTarget(T.map),e.clear(),e.renderBufferDirect(A,null,L,p,v,null)}function _(T,A,L,E){let M=null;const U=L.isPointLight===!0?T.customDistanceMaterial:T.customDepthMaterial;if(U!==void 0)M=U;else if(M=L.isPointLight===!0?l:o,e.localClippingEnabled&&A.clipShadows===!0&&Array.isArray(A.clippingPlanes)&&A.clippingPlanes.length!==0||A.displacementMap&&A.displacementScale!==0||A.alphaMap&&A.alphaTest>0||A.map&&A.alphaTest>0||A.alphaToCoverage===!0){const I=M.uuid,k=A.uuid;let Z=c[I];Z===void 0&&(Z={},c[I]=Z);let Y=Z[k];Y===void 0&&(Y=M.clone(),Z[k]=Y,A.addEventListener("dispose",C)),M=Y}if(M.visible=A.visible,M.wireframe=A.wireframe,E===zi?M.side=A.shadowSide!==null?A.shadowSide:A.side:M.side=A.shadowSide!==null?A.shadowSide:d[A.side],M.alphaMap=A.alphaMap,M.alphaTest=A.alphaToCoverage===!0?.5:A.alphaTest,M.map=A.map,M.clipShadows=A.clipShadows,M.clippingPlanes=A.clippingPlanes,M.clipIntersection=A.clipIntersection,M.displacementMap=A.displacementMap,M.displacementScale=A.displacementScale,M.displacementBias=A.displacementBias,M.wireframeLinewidth=A.wireframeLinewidth,M.linewidth=A.linewidth,L.isPointLight===!0&&M.isMeshDistanceMaterial===!0){const I=e.properties.get(M);I.light=L}return M}function y(T,A,L,E,M){if(T.visible===!1)return;if(T.layers.test(A.layers)&&(T.isMesh||T.isLine||T.isPoints)&&(T.castShadow||T.receiveShadow&&M===zi)&&(!T.frustumCulled||i.intersectsObject(T))){T.modelViewMatrix.multiplyMatrices(L.matrixWorldInverse,T.matrixWorld);const k=t.update(T),Z=T.material;if(Array.isArray(Z)){const Y=k.groups;for(let N=0,H=Y.length;N<H;N++){const F=Y[N],q=Z[F.materialIndex];if(q&&q.visible){const tt=_(T,q,E,M);T.onBeforeShadow(e,T,A,L,k,tt,F),e.renderBufferDirect(L,null,k,tt,T,F),T.onAfterShadow(e,T,A,L,k,tt,F)}}}else if(Z.visible){const Y=_(T,Z,E,M);T.onBeforeShadow(e,T,A,L,k,Y,null),e.renderBufferDirect(L,null,k,Y,T,null),T.onAfterShadow(e,T,A,L,k,Y,null)}}const I=T.children;for(let k=0,Z=I.length;k<Z;k++)y(I[k],A,L,E,M)}function C(T){T.target.removeEventListener("dispose",C);for(const L in c){const E=c[L],M=T.target.uuid;M in E&&(E[M].dispose(),delete E[M])}}}const hR={[Hh]:Gh,[Vh]:Wh,[kh]:Yh,[Ar]:Xh,[Gh]:Hh,[Wh]:Vh,[Yh]:kh,[Xh]:Ar};function dR(e,t){function n(){let D=!1;const ht=new ze;let lt=null;const ct=new ze(0,0,0,0);return{setMask:function(it){lt!==it&&!D&&(e.colorMask(it,it,it,it),lt=it)},setLocked:function(it){D=it},setClear:function(it,$,vt,It,ve){ve===!0&&(it*=It,$*=It,vt*=It),ht.set(it,$,vt,It),ct.equals(ht)===!1&&(e.clearColor(it,$,vt,It),ct.copy(ht))},reset:function(){D=!1,lt=null,ct.set(-1,0,0,0)}}}function i(){let D=!1,ht=!1,lt=null,ct=null,it=null;return{setReversed:function($){if(ht!==$){const vt=t.get("EXT_clip_control");$?vt.clipControlEXT(vt.LOWER_LEFT_EXT,vt.ZERO_TO_ONE_EXT):vt.clipControlEXT(vt.LOWER_LEFT_EXT,vt.NEGATIVE_ONE_TO_ONE_EXT),ht=$;const It=it;it=null,this.setClear(It)}},getReversed:function(){return ht},setTest:function($){$?J(e.DEPTH_TEST):dt(e.DEPTH_TEST)},setMask:function($){lt!==$&&!D&&(e.depthMask($),lt=$)},setFunc:function($){if(ht&&($=hR[$]),ct!==$){switch($){case Hh:e.depthFunc(e.NEVER);break;case Gh:e.depthFunc(e.ALWAYS);break;case Vh:e.depthFunc(e.LESS);break;case Ar:e.depthFunc(e.LEQUAL);break;case kh:e.depthFunc(e.EQUAL);break;case Xh:e.depthFunc(e.GEQUAL);break;case Wh:e.depthFunc(e.GREATER);break;case Yh:e.depthFunc(e.NOTEQUAL);break;default:e.depthFunc(e.LEQUAL)}ct=$}},setLocked:function($){D=$},setClear:function($){it!==$&&(ht&&($=1-$),e.clearDepth($),it=$)},reset:function(){D=!1,lt=null,ct=null,it=null,ht=!1}}}function a(){let D=!1,ht=null,lt=null,ct=null,it=null,$=null,vt=null,It=null,ve=null;return{setTest:function(ce){D||(ce?J(e.STENCIL_TEST):dt(e.STENCIL_TEST))},setMask:function(ce){ht!==ce&&!D&&(e.stencilMask(ce),ht=ce)},setFunc:function(ce,pi,ii){(lt!==ce||ct!==pi||it!==ii)&&(e.stencilFunc(ce,pi,ii),lt=ce,ct=pi,it=ii)},setOp:function(ce,pi,ii){($!==ce||vt!==pi||It!==ii)&&(e.stencilOp(ce,pi,ii),$=ce,vt=pi,It=ii)},setLocked:function(ce){D=ce},setClear:function(ce){ve!==ce&&(e.clearStencil(ce),ve=ce)},reset:function(){D=!1,ht=null,lt=null,ct=null,it=null,$=null,vt=null,It=null,ve=null}}}const s=new n,r=new i,o=new a,l=new WeakMap,c=new WeakMap;let f={},d={},h=new WeakMap,p=[],m=null,v=!1,x=null,u=null,g=null,_=null,y=null,C=null,T=null,A=new ae(0,0,0),L=0,E=!1,M=null,U=null,I=null,k=null,Z=null;const Y=e.getParameter(e.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let N=!1,H=0;const F=e.getParameter(e.VERSION);F.indexOf("WebGL")!==-1?(H=parseFloat(/^WebGL (\d)/.exec(F)[1]),N=H>=1):F.indexOf("OpenGL ES")!==-1&&(H=parseFloat(/^OpenGL ES (\d)/.exec(F)[1]),N=H>=2);let q=null,tt={};const st=e.getParameter(e.SCISSOR_BOX),at=e.getParameter(e.VIEWPORT),mt=new ze().fromArray(st),_t=new ze().fromArray(at);function Bt(D,ht,lt,ct){const it=new Uint8Array(4),$=e.createTexture();e.bindTexture(D,$),e.texParameteri(D,e.TEXTURE_MIN_FILTER,e.NEAREST),e.texParameteri(D,e.TEXTURE_MAG_FILTER,e.NEAREST);for(let vt=0;vt<lt;vt++)D===e.TEXTURE_3D||D===e.TEXTURE_2D_ARRAY?e.texImage3D(ht,0,e.RGBA,1,1,ct,0,e.RGBA,e.UNSIGNED_BYTE,it):e.texImage2D(ht+vt,0,e.RGBA,1,1,0,e.RGBA,e.UNSIGNED_BYTE,it);return $}const W={};W[e.TEXTURE_2D]=Bt(e.TEXTURE_2D,e.TEXTURE_2D,1),W[e.TEXTURE_CUBE_MAP]=Bt(e.TEXTURE_CUBE_MAP,e.TEXTURE_CUBE_MAP_POSITIVE_X,6),W[e.TEXTURE_2D_ARRAY]=Bt(e.TEXTURE_2D_ARRAY,e.TEXTURE_2D_ARRAY,1,1),W[e.TEXTURE_3D]=Bt(e.TEXTURE_3D,e.TEXTURE_3D,1,1),s.setClear(0,0,0,1),r.setClear(1),o.setClear(0),J(e.DEPTH_TEST),r.setFunc(Ar),Qt(!1),Jt(Am),J(e.CULL_FACE),Ee(ji);function J(D){f[D]!==!0&&(e.enable(D),f[D]=!0)}function dt(D){f[D]!==!1&&(e.disable(D),f[D]=!1)}function zt(D,ht){return d[D]!==ht?(e.bindFramebuffer(D,ht),d[D]=ht,D===e.DRAW_FRAMEBUFFER&&(d[e.FRAMEBUFFER]=ht),D===e.FRAMEBUFFER&&(d[e.DRAW_FRAMEBUFFER]=ht),!0):!1}function Tt(D,ht){let lt=p,ct=!1;if(D){lt=h.get(ht),lt===void 0&&(lt=[],h.set(ht,lt));const it=D.textures;if(lt.length!==it.length||lt[0]!==e.COLOR_ATTACHMENT0){for(let $=0,vt=it.length;$<vt;$++)lt[$]=e.COLOR_ATTACHMENT0+$;lt.length=it.length,ct=!0}}else lt[0]!==e.BACK&&(lt[0]=e.BACK,ct=!0);ct&&e.drawBuffers(lt)}function Kt(D){return m!==D?(e.useProgram(D),m=D,!0):!1}const Je={[ns]:e.FUNC_ADD,[a1]:e.FUNC_SUBTRACT,[s1]:e.FUNC_REVERSE_SUBTRACT};Je[r1]=e.MIN,Je[o1]=e.MAX;const qt={[l1]:e.ZERO,[c1]:e.ONE,[u1]:e.SRC_COLOR,[Bh]:e.SRC_ALPHA,[x1]:e.SRC_ALPHA_SATURATE,[p1]:e.DST_COLOR,[h1]:e.DST_ALPHA,[f1]:e.ONE_MINUS_SRC_COLOR,[Ih]:e.ONE_MINUS_SRC_ALPHA,[m1]:e.ONE_MINUS_DST_COLOR,[d1]:e.ONE_MINUS_DST_ALPHA,[g1]:e.CONSTANT_COLOR,[_1]:e.ONE_MINUS_CONSTANT_COLOR,[v1]:e.CONSTANT_ALPHA,[S1]:e.ONE_MINUS_CONSTANT_ALPHA};function Ee(D,ht,lt,ct,it,$,vt,It,ve,ce){if(D===ji){v===!0&&(dt(e.BLEND),v=!1);return}if(v===!1&&(J(e.BLEND),v=!0),D!==i1){if(D!==x||ce!==E){if((u!==ns||y!==ns)&&(e.blendEquation(e.FUNC_ADD),u=ns,y=ns),ce)switch(D){case dr:e.blendFuncSeparate(e.ONE,e.ONE_MINUS_SRC_ALPHA,e.ONE,e.ONE_MINUS_SRC_ALPHA);break;case Rm:e.blendFunc(e.ONE,e.ONE);break;case Cm:e.blendFuncSeparate(e.ZERO,e.ONE_MINUS_SRC_COLOR,e.ZERO,e.ONE);break;case wm:e.blendFuncSeparate(e.DST_COLOR,e.ONE_MINUS_SRC_ALPHA,e.ZERO,e.ONE);break;default:Oe("WebGLState: Invalid blending: ",D);break}else switch(D){case dr:e.blendFuncSeparate(e.SRC_ALPHA,e.ONE_MINUS_SRC_ALPHA,e.ONE,e.ONE_MINUS_SRC_ALPHA);break;case Rm:e.blendFuncSeparate(e.SRC_ALPHA,e.ONE,e.ONE,e.ONE);break;case Cm:Oe("WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case wm:Oe("WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:Oe("WebGLState: Invalid blending: ",D);break}g=null,_=null,C=null,T=null,A.set(0,0,0),L=0,x=D,E=ce}return}it=it||ht,$=$||lt,vt=vt||ct,(ht!==u||it!==y)&&(e.blendEquationSeparate(Je[ht],Je[it]),u=ht,y=it),(lt!==g||ct!==_||$!==C||vt!==T)&&(e.blendFuncSeparate(qt[lt],qt[ct],qt[$],qt[vt]),g=lt,_=ct,C=$,T=vt),(It.equals(A)===!1||ve!==L)&&(e.blendColor(It.r,It.g,It.b,ve),A.copy(It),L=ve),x=D,E=!1}function w(D,ht){D.side===Ii?dt(e.CULL_FACE):J(e.CULL_FACE);let lt=D.side===bn;ht&&(lt=!lt),Qt(lt),D.blending===dr&&D.transparent===!1?Ee(ji):Ee(D.blending,D.blendEquation,D.blendSrc,D.blendDst,D.blendEquationAlpha,D.blendSrcAlpha,D.blendDstAlpha,D.blendColor,D.blendAlpha,D.premultipliedAlpha),r.setFunc(D.depthFunc),r.setTest(D.depthTest),r.setMask(D.depthWrite),s.setMask(D.colorWrite);const ct=D.stencilWrite;o.setTest(ct),ct&&(o.setMask(D.stencilWriteMask),o.setFunc(D.stencilFunc,D.stencilRef,D.stencilFuncMask),o.setOp(D.stencilFail,D.stencilZFail,D.stencilZPass)),yt(D.polygonOffset,D.polygonOffsetFactor,D.polygonOffsetUnits),D.alphaToCoverage===!0?J(e.SAMPLE_ALPHA_TO_COVERAGE):dt(e.SAMPLE_ALPHA_TO_COVERAGE)}function Qt(D){M!==D&&(D?e.frontFace(e.CW):e.frontFace(e.CCW),M=D)}function Jt(D){D!==t1?(J(e.CULL_FACE),D!==U&&(D===Am?e.cullFace(e.BACK):D===e1?e.cullFace(e.FRONT):e.cullFace(e.FRONT_AND_BACK))):dt(e.CULL_FACE),U=D}function ge(D){D!==I&&(N&&e.lineWidth(D),I=D)}function yt(D,ht,lt){D?(J(e.POLYGON_OFFSET_FILL),(k!==ht||Z!==lt)&&(e.polygonOffset(ht,lt),k=ht,Z=lt)):dt(e.POLYGON_OFFSET_FILL)}function Ae(D){D?J(e.SCISSOR_TEST):dt(e.SCISSOR_TEST)}function Rt(D){D===void 0&&(D=e.TEXTURE0+Y-1),q!==D&&(e.activeTexture(D),q=D)}function Ht(D,ht,lt){lt===void 0&&(q===null?lt=e.TEXTURE0+Y-1:lt=q);let ct=tt[lt];ct===void 0&&(ct={type:void 0,texture:void 0},tt[lt]=ct),(ct.type!==D||ct.texture!==ht)&&(q!==lt&&(e.activeTexture(lt),q=lt),e.bindTexture(D,ht||W[D]),ct.type=D,ct.texture=ht)}function R(){const D=tt[q];D!==void 0&&D.type!==void 0&&(e.bindTexture(D.type,null),D.type=void 0,D.texture=void 0)}function S(){try{e.compressedTexImage2D(...arguments)}catch(D){D("WebGLState:",D)}}function B(){try{e.compressedTexImage3D(...arguments)}catch(D){D("WebGLState:",D)}}function K(){try{e.texSubImage2D(...arguments)}catch(D){D("WebGLState:",D)}}function et(){try{e.texSubImage3D(...arguments)}catch(D){D("WebGLState:",D)}}function X(){try{e.compressedTexSubImage2D(...arguments)}catch(D){D("WebGLState:",D)}}function Et(){try{e.compressedTexSubImage3D(...arguments)}catch(D){D("WebGLState:",D)}}function ft(){try{e.texStorage2D(...arguments)}catch(D){D("WebGLState:",D)}}function Ct(){try{e.texStorage3D(...arguments)}catch(D){D("WebGLState:",D)}}function Mt(){try{e.texImage2D(...arguments)}catch(D){D("WebGLState:",D)}}function nt(){try{e.texImage3D(...arguments)}catch(D){D("WebGLState:",D)}}function ot(D){mt.equals(D)===!1&&(e.scissor(D.x,D.y,D.z,D.w),mt.copy(D))}function Lt(D){_t.equals(D)===!1&&(e.viewport(D.x,D.y,D.z,D.w),_t.copy(D))}function Dt(D,ht){let lt=c.get(ht);lt===void 0&&(lt=new WeakMap,c.set(ht,lt));let ct=lt.get(D);ct===void 0&&(ct=e.getUniformBlockIndex(ht,D.name),lt.set(D,ct))}function xt(D,ht){const ct=c.get(ht).get(D);l.get(ht)!==ct&&(e.uniformBlockBinding(ht,ct,D.__bindingPointIndex),l.set(ht,ct))}function Pt(){e.disable(e.BLEND),e.disable(e.CULL_FACE),e.disable(e.DEPTH_TEST),e.disable(e.POLYGON_OFFSET_FILL),e.disable(e.SCISSOR_TEST),e.disable(e.STENCIL_TEST),e.disable(e.SAMPLE_ALPHA_TO_COVERAGE),e.blendEquation(e.FUNC_ADD),e.blendFunc(e.ONE,e.ZERO),e.blendFuncSeparate(e.ONE,e.ZERO,e.ONE,e.ZERO),e.blendColor(0,0,0,0),e.colorMask(!0,!0,!0,!0),e.clearColor(0,0,0,0),e.depthMask(!0),e.depthFunc(e.LESS),r.setReversed(!1),e.clearDepth(1),e.stencilMask(4294967295),e.stencilFunc(e.ALWAYS,0,4294967295),e.stencilOp(e.KEEP,e.KEEP,e.KEEP),e.clearStencil(0),e.cullFace(e.BACK),e.frontFace(e.CCW),e.polygonOffset(0,0),e.activeTexture(e.TEXTURE0),e.bindFramebuffer(e.FRAMEBUFFER,null),e.bindFramebuffer(e.DRAW_FRAMEBUFFER,null),e.bindFramebuffer(e.READ_FRAMEBUFFER,null),e.useProgram(null),e.lineWidth(1),e.scissor(0,0,e.canvas.width,e.canvas.height),e.viewport(0,0,e.canvas.width,e.canvas.height),f={},q=null,tt={},d={},h=new WeakMap,p=[],m=null,v=!1,x=null,u=null,g=null,_=null,y=null,C=null,T=null,A=new ae(0,0,0),L=0,E=!1,M=null,U=null,I=null,k=null,Z=null,mt.set(0,0,e.canvas.width,e.canvas.height),_t.set(0,0,e.canvas.width,e.canvas.height),s.reset(),r.reset(),o.reset()}return{buffers:{color:s,depth:r,stencil:o},enable:J,disable:dt,bindFramebuffer:zt,drawBuffers:Tt,useProgram:Kt,setBlending:Ee,setMaterial:w,setFlipSided:Qt,setCullFace:Jt,setLineWidth:ge,setPolygonOffset:yt,setScissorTest:Ae,activeTexture:Rt,bindTexture:Ht,unbindTexture:R,compressedTexImage2D:S,compressedTexImage3D:B,texImage2D:Mt,texImage3D:nt,updateUBOMapping:Dt,uniformBlockBinding:xt,texStorage2D:ft,texStorage3D:Ct,texSubImage2D:K,texSubImage3D:et,compressedTexSubImage2D:X,compressedTexSubImage3D:Et,scissor:ot,viewport:Lt,reset:Pt}}function pR(e,t,n,i,a,s,r){const o=t.has("WEBGL_multisampled_render_to_texture")?t.get("WEBGL_multisampled_render_to_texture"):null,l=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),c=new Xt,f=new WeakMap;let d;const h=new WeakMap;let p=!1;try{p=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function m(R,S){return p?new OffscreenCanvas(R,S):Kc("canvas")}function v(R,S,B){let K=1;const et=Ht(R);if((et.width>B||et.height>B)&&(K=B/Math.max(et.width,et.height)),K<1)if(typeof HTMLImageElement<"u"&&R instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&R instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&R instanceof ImageBitmap||typeof VideoFrame<"u"&&R instanceof VideoFrame){const X=Math.floor(K*et.width),Et=Math.floor(K*et.height);d===void 0&&(d=m(X,Et));const ft=S?m(X,Et):d;return ft.width=X,ft.height=Et,ft.getContext("2d").drawImage(R,0,0,X,Et),Ft("WebGLRenderer: Texture has been resized from ("+et.width+"x"+et.height+") to ("+X+"x"+Et+")."),ft}else return"data"in R&&Ft("WebGLRenderer: Image in DataTexture is too big ("+et.width+"x"+et.height+")."),R;return R}function x(R){return R.generateMipmaps}function u(R){e.generateMipmap(R)}function g(R){return R.isWebGLCubeRenderTarget?e.TEXTURE_CUBE_MAP:R.isWebGL3DRenderTarget?e.TEXTURE_3D:R.isWebGLArrayRenderTarget||R.isCompressedArrayTexture?e.TEXTURE_2D_ARRAY:e.TEXTURE_2D}function _(R,S,B,K,et=!1){if(R!==null){if(e[R]!==void 0)return e[R];Ft("WebGLRenderer: Attempt to use non-existing WebGL internal format '"+R+"'")}let X=S;if(S===e.RED&&(B===e.FLOAT&&(X=e.R32F),B===e.HALF_FLOAT&&(X=e.R16F),B===e.UNSIGNED_BYTE&&(X=e.R8)),S===e.RED_INTEGER&&(B===e.UNSIGNED_BYTE&&(X=e.R8UI),B===e.UNSIGNED_SHORT&&(X=e.R16UI),B===e.UNSIGNED_INT&&(X=e.R32UI),B===e.BYTE&&(X=e.R8I),B===e.SHORT&&(X=e.R16I),B===e.INT&&(X=e.R32I)),S===e.RG&&(B===e.FLOAT&&(X=e.RG32F),B===e.HALF_FLOAT&&(X=e.RG16F),B===e.UNSIGNED_BYTE&&(X=e.RG8)),S===e.RG_INTEGER&&(B===e.UNSIGNED_BYTE&&(X=e.RG8UI),B===e.UNSIGNED_SHORT&&(X=e.RG16UI),B===e.UNSIGNED_INT&&(X=e.RG32UI),B===e.BYTE&&(X=e.RG8I),B===e.SHORT&&(X=e.RG16I),B===e.INT&&(X=e.RG32I)),S===e.RGB_INTEGER&&(B===e.UNSIGNED_BYTE&&(X=e.RGB8UI),B===e.UNSIGNED_SHORT&&(X=e.RGB16UI),B===e.UNSIGNED_INT&&(X=e.RGB32UI),B===e.BYTE&&(X=e.RGB8I),B===e.SHORT&&(X=e.RGB16I),B===e.INT&&(X=e.RGB32I)),S===e.RGBA_INTEGER&&(B===e.UNSIGNED_BYTE&&(X=e.RGBA8UI),B===e.UNSIGNED_SHORT&&(X=e.RGBA16UI),B===e.UNSIGNED_INT&&(X=e.RGBA32UI),B===e.BYTE&&(X=e.RGBA8I),B===e.SHORT&&(X=e.RGBA16I),B===e.INT&&(X=e.RGBA32I)),S===e.RGB&&(B===e.UNSIGNED_INT_5_9_9_9_REV&&(X=e.RGB9_E5),B===e.UNSIGNED_INT_10F_11F_11F_REV&&(X=e.R11F_G11F_B10F)),S===e.RGBA){const Et=et?jc:ie.getTransfer(K);B===e.FLOAT&&(X=e.RGBA32F),B===e.HALF_FLOAT&&(X=e.RGBA16F),B===e.UNSIGNED_BYTE&&(X=Et===fe?e.SRGB8_ALPHA8:e.RGBA8),B===e.UNSIGNED_SHORT_4_4_4_4&&(X=e.RGBA4),B===e.UNSIGNED_SHORT_5_5_5_1&&(X=e.RGB5_A1)}return(X===e.R16F||X===e.R32F||X===e.RG16F||X===e.RG32F||X===e.RGBA16F||X===e.RGBA32F)&&t.get("EXT_color_buffer_float"),X}function y(R,S){let B;return R?S===null||S===ms||S===ko?B=e.DEPTH24_STENCIL8:S===Xi?B=e.DEPTH32F_STENCIL8:S===Vo&&(B=e.DEPTH24_STENCIL8,Ft("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):S===null||S===ms||S===ko?B=e.DEPTH_COMPONENT24:S===Xi?B=e.DEPTH_COMPONENT32F:S===Vo&&(B=e.DEPTH_COMPONENT16),B}function C(R,S){return x(R)===!0||R.isFramebufferTexture&&R.minFilter!==In&&R.minFilter!==$n?Math.log2(Math.max(S.width,S.height))+1:R.mipmaps!==void 0&&R.mipmaps.length>0?R.mipmaps.length:R.isCompressedTexture&&Array.isArray(R.image)?S.mipmaps.length:1}function T(R){const S=R.target;S.removeEventListener("dispose",T),L(S),S.isVideoTexture&&f.delete(S)}function A(R){const S=R.target;S.removeEventListener("dispose",A),M(S)}function L(R){const S=i.get(R);if(S.__webglInit===void 0)return;const B=R.source,K=h.get(B);if(K){const et=K[S.__cacheKey];et.usedTimes--,et.usedTimes===0&&E(R),Object.keys(K).length===0&&h.delete(B)}i.remove(R)}function E(R){const S=i.get(R);e.deleteTexture(S.__webglTexture);const B=R.source,K=h.get(B);delete K[S.__cacheKey],r.memory.textures--}function M(R){const S=i.get(R);if(R.depthTexture&&(R.depthTexture.dispose(),i.remove(R.depthTexture)),R.isWebGLCubeRenderTarget)for(let K=0;K<6;K++){if(Array.isArray(S.__webglFramebuffer[K]))for(let et=0;et<S.__webglFramebuffer[K].length;et++)e.deleteFramebuffer(S.__webglFramebuffer[K][et]);else e.deleteFramebuffer(S.__webglFramebuffer[K]);S.__webglDepthbuffer&&e.deleteRenderbuffer(S.__webglDepthbuffer[K])}else{if(Array.isArray(S.__webglFramebuffer))for(let K=0;K<S.__webglFramebuffer.length;K++)e.deleteFramebuffer(S.__webglFramebuffer[K]);else e.deleteFramebuffer(S.__webglFramebuffer);if(S.__webglDepthbuffer&&e.deleteRenderbuffer(S.__webglDepthbuffer),S.__webglMultisampledFramebuffer&&e.deleteFramebuffer(S.__webglMultisampledFramebuffer),S.__webglColorRenderbuffer)for(let K=0;K<S.__webglColorRenderbuffer.length;K++)S.__webglColorRenderbuffer[K]&&e.deleteRenderbuffer(S.__webglColorRenderbuffer[K]);S.__webglDepthRenderbuffer&&e.deleteRenderbuffer(S.__webglDepthRenderbuffer)}const B=R.textures;for(let K=0,et=B.length;K<et;K++){const X=i.get(B[K]);X.__webglTexture&&(e.deleteTexture(X.__webglTexture),r.memory.textures--),i.remove(B[K])}i.remove(R)}let U=0;function I(){U=0}function k(){const R=U;return R>=a.maxTextures&&Ft("WebGLTextures: Trying to use "+R+" texture units while this GPU supports only "+a.maxTextures),U+=1,R}function Z(R){const S=[];return S.push(R.wrapS),S.push(R.wrapT),S.push(R.wrapR||0),S.push(R.magFilter),S.push(R.minFilter),S.push(R.anisotropy),S.push(R.internalFormat),S.push(R.format),S.push(R.type),S.push(R.generateMipmaps),S.push(R.premultiplyAlpha),S.push(R.flipY),S.push(R.unpackAlignment),S.push(R.colorSpace),S.join()}function Y(R,S){const B=i.get(R);if(R.isVideoTexture&&Ae(R),R.isRenderTargetTexture===!1&&R.isExternalTexture!==!0&&R.version>0&&B.__version!==R.version){const K=R.image;if(K===null)Ft("WebGLRenderer: Texture marked for update but no image data found.");else if(K.complete===!1)Ft("WebGLRenderer: Texture marked for update but image is incomplete");else{W(B,R,S);return}}else R.isExternalTexture&&(B.__webglTexture=R.sourceTexture?R.sourceTexture:null);n.bindTexture(e.TEXTURE_2D,B.__webglTexture,e.TEXTURE0+S)}function N(R,S){const B=i.get(R);if(R.isRenderTargetTexture===!1&&R.version>0&&B.__version!==R.version){W(B,R,S);return}else R.isExternalTexture&&(B.__webglTexture=R.sourceTexture?R.sourceTexture:null);n.bindTexture(e.TEXTURE_2D_ARRAY,B.__webglTexture,e.TEXTURE0+S)}function H(R,S){const B=i.get(R);if(R.isRenderTargetTexture===!1&&R.version>0&&B.__version!==R.version){W(B,R,S);return}n.bindTexture(e.TEXTURE_3D,B.__webglTexture,e.TEXTURE0+S)}function F(R,S){const B=i.get(R);if(R.version>0&&B.__version!==R.version){J(B,R,S);return}n.bindTexture(e.TEXTURE_CUBE_MAP,B.__webglTexture,e.TEXTURE0+S)}const q={[Zh]:e.REPEAT,[ki]:e.CLAMP_TO_EDGE,[Kh]:e.MIRRORED_REPEAT},tt={[In]:e.NEAREST,[D1]:e.NEAREST_MIPMAP_NEAREST,[wl]:e.NEAREST_MIPMAP_LINEAR,[$n]:e.LINEAR,[ff]:e.LINEAR_MIPMAP_NEAREST,[as]:e.LINEAR_MIPMAP_LINEAR},st={[P1]:e.NEVER,[G1]:e.ALWAYS,[z1]:e.LESS,[$v]:e.LEQUAL,[F1]:e.EQUAL,[H1]:e.GEQUAL,[B1]:e.GREATER,[I1]:e.NOTEQUAL};function at(R,S){if(S.type===Xi&&t.has("OES_texture_float_linear")===!1&&(S.magFilter===$n||S.magFilter===ff||S.magFilter===wl||S.magFilter===as||S.minFilter===$n||S.minFilter===ff||S.minFilter===wl||S.minFilter===as)&&Ft("WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),e.texParameteri(R,e.TEXTURE_WRAP_S,q[S.wrapS]),e.texParameteri(R,e.TEXTURE_WRAP_T,q[S.wrapT]),(R===e.TEXTURE_3D||R===e.TEXTURE_2D_ARRAY)&&e.texParameteri(R,e.TEXTURE_WRAP_R,q[S.wrapR]),e.texParameteri(R,e.TEXTURE_MAG_FILTER,tt[S.magFilter]),e.texParameteri(R,e.TEXTURE_MIN_FILTER,tt[S.minFilter]),S.compareFunction&&(e.texParameteri(R,e.TEXTURE_COMPARE_MODE,e.COMPARE_REF_TO_TEXTURE),e.texParameteri(R,e.TEXTURE_COMPARE_FUNC,st[S.compareFunction])),t.has("EXT_texture_filter_anisotropic")===!0){if(S.magFilter===In||S.minFilter!==wl&&S.minFilter!==as||S.type===Xi&&t.has("OES_texture_float_linear")===!1)return;if(S.anisotropy>1||i.get(S).__currentAnisotropy){const B=t.get("EXT_texture_filter_anisotropic");e.texParameterf(R,B.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(S.anisotropy,a.getMaxAnisotropy())),i.get(S).__currentAnisotropy=S.anisotropy}}}function mt(R,S){let B=!1;R.__webglInit===void 0&&(R.__webglInit=!0,S.addEventListener("dispose",T));const K=S.source;let et=h.get(K);et===void 0&&(et={},h.set(K,et));const X=Z(S);if(X!==R.__cacheKey){et[X]===void 0&&(et[X]={texture:e.createTexture(),usedTimes:0},r.memory.textures++,B=!0),et[X].usedTimes++;const Et=et[R.__cacheKey];Et!==void 0&&(et[R.__cacheKey].usedTimes--,Et.usedTimes===0&&E(S)),R.__cacheKey=X,R.__webglTexture=et[X].texture}return B}function _t(R,S,B){return Math.floor(Math.floor(R/B)/S)}function Bt(R,S,B,K){const X=R.updateRanges;if(X.length===0)n.texSubImage2D(e.TEXTURE_2D,0,0,0,S.width,S.height,B,K,S.data);else{X.sort((nt,ot)=>nt.start-ot.start);let Et=0;for(let nt=1;nt<X.length;nt++){const ot=X[Et],Lt=X[nt],Dt=ot.start+ot.count,xt=_t(Lt.start,S.width,4),Pt=_t(ot.start,S.width,4);Lt.start<=Dt+1&&xt===Pt&&_t(Lt.start+Lt.count-1,S.width,4)===xt?ot.count=Math.max(ot.count,Lt.start+Lt.count-ot.start):(++Et,X[Et]=Lt)}X.length=Et+1;const ft=e.getParameter(e.UNPACK_ROW_LENGTH),Ct=e.getParameter(e.UNPACK_SKIP_PIXELS),Mt=e.getParameter(e.UNPACK_SKIP_ROWS);e.pixelStorei(e.UNPACK_ROW_LENGTH,S.width);for(let nt=0,ot=X.length;nt<ot;nt++){const Lt=X[nt],Dt=Math.floor(Lt.start/4),xt=Math.ceil(Lt.count/4),Pt=Dt%S.width,D=Math.floor(Dt/S.width),ht=xt,lt=1;e.pixelStorei(e.UNPACK_SKIP_PIXELS,Pt),e.pixelStorei(e.UNPACK_SKIP_ROWS,D),n.texSubImage2D(e.TEXTURE_2D,0,Pt,D,ht,lt,B,K,S.data)}R.clearUpdateRanges(),e.pixelStorei(e.UNPACK_ROW_LENGTH,ft),e.pixelStorei(e.UNPACK_SKIP_PIXELS,Ct),e.pixelStorei(e.UNPACK_SKIP_ROWS,Mt)}}function W(R,S,B){let K=e.TEXTURE_2D;(S.isDataArrayTexture||S.isCompressedArrayTexture)&&(K=e.TEXTURE_2D_ARRAY),S.isData3DTexture&&(K=e.TEXTURE_3D);const et=mt(R,S),X=S.source;n.bindTexture(K,R.__webglTexture,e.TEXTURE0+B);const Et=i.get(X);if(X.version!==Et.__version||et===!0){n.activeTexture(e.TEXTURE0+B);const ft=ie.getPrimaries(ie.workingColorSpace),Ct=S.colorSpace===_a?null:ie.getPrimaries(S.colorSpace),Mt=S.colorSpace===_a||ft===Ct?e.NONE:e.BROWSER_DEFAULT_WEBGL;e.pixelStorei(e.UNPACK_FLIP_Y_WEBGL,S.flipY),e.pixelStorei(e.UNPACK_PREMULTIPLY_ALPHA_WEBGL,S.premultiplyAlpha),e.pixelStorei(e.UNPACK_ALIGNMENT,S.unpackAlignment),e.pixelStorei(e.UNPACK_COLORSPACE_CONVERSION_WEBGL,Mt);let nt=v(S.image,!1,a.maxTextureSize);nt=Rt(S,nt);const ot=s.convert(S.format,S.colorSpace),Lt=s.convert(S.type);let Dt=_(S.internalFormat,ot,Lt,S.colorSpace,S.isVideoTexture);at(K,S);let xt;const Pt=S.mipmaps,D=S.isVideoTexture!==!0,ht=Et.__version===void 0||et===!0,lt=X.dataReady,ct=C(S,nt);if(S.isDepthTexture)Dt=y(S.format===Wo,S.type),ht&&(D?n.texStorage2D(e.TEXTURE_2D,1,Dt,nt.width,nt.height):n.texImage2D(e.TEXTURE_2D,0,Dt,nt.width,nt.height,0,ot,Lt,null));else if(S.isDataTexture)if(Pt.length>0){D&&ht&&n.texStorage2D(e.TEXTURE_2D,ct,Dt,Pt[0].width,Pt[0].height);for(let it=0,$=Pt.length;it<$;it++)xt=Pt[it],D?lt&&n.texSubImage2D(e.TEXTURE_2D,it,0,0,xt.width,xt.height,ot,Lt,xt.data):n.texImage2D(e.TEXTURE_2D,it,Dt,xt.width,xt.height,0,ot,Lt,xt.data);S.generateMipmaps=!1}else D?(ht&&n.texStorage2D(e.TEXTURE_2D,ct,Dt,nt.width,nt.height),lt&&Bt(S,nt,ot,Lt)):n.texImage2D(e.TEXTURE_2D,0,Dt,nt.width,nt.height,0,ot,Lt,nt.data);else if(S.isCompressedTexture)if(S.isCompressedArrayTexture){D&&ht&&n.texStorage3D(e.TEXTURE_2D_ARRAY,ct,Dt,Pt[0].width,Pt[0].height,nt.depth);for(let it=0,$=Pt.length;it<$;it++)if(xt=Pt[it],S.format!==fi)if(ot!==null)if(D){if(lt)if(S.layerUpdates.size>0){const vt=ix(xt.width,xt.height,S.format,S.type);for(const It of S.layerUpdates){const ve=xt.data.subarray(It*vt/xt.data.BYTES_PER_ELEMENT,(It+1)*vt/xt.data.BYTES_PER_ELEMENT);n.compressedTexSubImage3D(e.TEXTURE_2D_ARRAY,it,0,0,It,xt.width,xt.height,1,ot,ve)}S.clearLayerUpdates()}else n.compressedTexSubImage3D(e.TEXTURE_2D_ARRAY,it,0,0,0,xt.width,xt.height,nt.depth,ot,xt.data)}else n.compressedTexImage3D(e.TEXTURE_2D_ARRAY,it,Dt,xt.width,xt.height,nt.depth,0,xt.data,0,0);else Ft("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else D?lt&&n.texSubImage3D(e.TEXTURE_2D_ARRAY,it,0,0,0,xt.width,xt.height,nt.depth,ot,Lt,xt.data):n.texImage3D(e.TEXTURE_2D_ARRAY,it,Dt,xt.width,xt.height,nt.depth,0,ot,Lt,xt.data)}else{D&&ht&&n.texStorage2D(e.TEXTURE_2D,ct,Dt,Pt[0].width,Pt[0].height);for(let it=0,$=Pt.length;it<$;it++)xt=Pt[it],S.format!==fi?ot!==null?D?lt&&n.compressedTexSubImage2D(e.TEXTURE_2D,it,0,0,xt.width,xt.height,ot,xt.data):n.compressedTexImage2D(e.TEXTURE_2D,it,Dt,xt.width,xt.height,0,xt.data):Ft("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):D?lt&&n.texSubImage2D(e.TEXTURE_2D,it,0,0,xt.width,xt.height,ot,Lt,xt.data):n.texImage2D(e.TEXTURE_2D,it,Dt,xt.width,xt.height,0,ot,Lt,xt.data)}else if(S.isDataArrayTexture)if(D){if(ht&&n.texStorage3D(e.TEXTURE_2D_ARRAY,ct,Dt,nt.width,nt.height,nt.depth),lt)if(S.layerUpdates.size>0){const it=ix(nt.width,nt.height,S.format,S.type);for(const $ of S.layerUpdates){const vt=nt.data.subarray($*it/nt.data.BYTES_PER_ELEMENT,($+1)*it/nt.data.BYTES_PER_ELEMENT);n.texSubImage3D(e.TEXTURE_2D_ARRAY,0,0,0,$,nt.width,nt.height,1,ot,Lt,vt)}S.clearLayerUpdates()}else n.texSubImage3D(e.TEXTURE_2D_ARRAY,0,0,0,0,nt.width,nt.height,nt.depth,ot,Lt,nt.data)}else n.texImage3D(e.TEXTURE_2D_ARRAY,0,Dt,nt.width,nt.height,nt.depth,0,ot,Lt,nt.data);else if(S.isData3DTexture)D?(ht&&n.texStorage3D(e.TEXTURE_3D,ct,Dt,nt.width,nt.height,nt.depth),lt&&n.texSubImage3D(e.TEXTURE_3D,0,0,0,0,nt.width,nt.height,nt.depth,ot,Lt,nt.data)):n.texImage3D(e.TEXTURE_3D,0,Dt,nt.width,nt.height,nt.depth,0,ot,Lt,nt.data);else if(S.isFramebufferTexture){if(ht)if(D)n.texStorage2D(e.TEXTURE_2D,ct,Dt,nt.width,nt.height);else{let it=nt.width,$=nt.height;for(let vt=0;vt<ct;vt++)n.texImage2D(e.TEXTURE_2D,vt,Dt,it,$,0,ot,Lt,null),it>>=1,$>>=1}}else if(Pt.length>0){if(D&&ht){const it=Ht(Pt[0]);n.texStorage2D(e.TEXTURE_2D,ct,Dt,it.width,it.height)}for(let it=0,$=Pt.length;it<$;it++)xt=Pt[it],D?lt&&n.texSubImage2D(e.TEXTURE_2D,it,0,0,ot,Lt,xt):n.texImage2D(e.TEXTURE_2D,it,Dt,ot,Lt,xt);S.generateMipmaps=!1}else if(D){if(ht){const it=Ht(nt);n.texStorage2D(e.TEXTURE_2D,ct,Dt,it.width,it.height)}lt&&n.texSubImage2D(e.TEXTURE_2D,0,0,0,ot,Lt,nt)}else n.texImage2D(e.TEXTURE_2D,0,Dt,ot,Lt,nt);x(S)&&u(K),Et.__version=X.version,S.onUpdate&&S.onUpdate(S)}R.__version=S.version}function J(R,S,B){if(S.image.length!==6)return;const K=mt(R,S),et=S.source;n.bindTexture(e.TEXTURE_CUBE_MAP,R.__webglTexture,e.TEXTURE0+B);const X=i.get(et);if(et.version!==X.__version||K===!0){n.activeTexture(e.TEXTURE0+B);const Et=ie.getPrimaries(ie.workingColorSpace),ft=S.colorSpace===_a?null:ie.getPrimaries(S.colorSpace),Ct=S.colorSpace===_a||Et===ft?e.NONE:e.BROWSER_DEFAULT_WEBGL;e.pixelStorei(e.UNPACK_FLIP_Y_WEBGL,S.flipY),e.pixelStorei(e.UNPACK_PREMULTIPLY_ALPHA_WEBGL,S.premultiplyAlpha),e.pixelStorei(e.UNPACK_ALIGNMENT,S.unpackAlignment),e.pixelStorei(e.UNPACK_COLORSPACE_CONVERSION_WEBGL,Ct);const Mt=S.isCompressedTexture||S.image[0].isCompressedTexture,nt=S.image[0]&&S.image[0].isDataTexture,ot=[];for(let $=0;$<6;$++)!Mt&&!nt?ot[$]=v(S.image[$],!0,a.maxCubemapSize):ot[$]=nt?S.image[$].image:S.image[$],ot[$]=Rt(S,ot[$]);const Lt=ot[0],Dt=s.convert(S.format,S.colorSpace),xt=s.convert(S.type),Pt=_(S.internalFormat,Dt,xt,S.colorSpace),D=S.isVideoTexture!==!0,ht=X.__version===void 0||K===!0,lt=et.dataReady;let ct=C(S,Lt);at(e.TEXTURE_CUBE_MAP,S);let it;if(Mt){D&&ht&&n.texStorage2D(e.TEXTURE_CUBE_MAP,ct,Pt,Lt.width,Lt.height);for(let $=0;$<6;$++){it=ot[$].mipmaps;for(let vt=0;vt<it.length;vt++){const It=it[vt];S.format!==fi?Dt!==null?D?lt&&n.compressedTexSubImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+$,vt,0,0,It.width,It.height,Dt,It.data):n.compressedTexImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+$,vt,Pt,It.width,It.height,0,It.data):Ft("WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):D?lt&&n.texSubImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+$,vt,0,0,It.width,It.height,Dt,xt,It.data):n.texImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+$,vt,Pt,It.width,It.height,0,Dt,xt,It.data)}}}else{if(it=S.mipmaps,D&&ht){it.length>0&&ct++;const $=Ht(ot[0]);n.texStorage2D(e.TEXTURE_CUBE_MAP,ct,Pt,$.width,$.height)}for(let $=0;$<6;$++)if(nt){D?lt&&n.texSubImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+$,0,0,0,ot[$].width,ot[$].height,Dt,xt,ot[$].data):n.texImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+$,0,Pt,ot[$].width,ot[$].height,0,Dt,xt,ot[$].data);for(let vt=0;vt<it.length;vt++){const ve=it[vt].image[$].image;D?lt&&n.texSubImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+$,vt+1,0,0,ve.width,ve.height,Dt,xt,ve.data):n.texImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+$,vt+1,Pt,ve.width,ve.height,0,Dt,xt,ve.data)}}else{D?lt&&n.texSubImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+$,0,0,0,Dt,xt,ot[$]):n.texImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+$,0,Pt,Dt,xt,ot[$]);for(let vt=0;vt<it.length;vt++){const It=it[vt];D?lt&&n.texSubImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+$,vt+1,0,0,Dt,xt,It.image[$]):n.texImage2D(e.TEXTURE_CUBE_MAP_POSITIVE_X+$,vt+1,Pt,Dt,xt,It.image[$])}}}x(S)&&u(e.TEXTURE_CUBE_MAP),X.__version=et.version,S.onUpdate&&S.onUpdate(S)}R.__version=S.version}function dt(R,S,B,K,et,X){const Et=s.convert(B.format,B.colorSpace),ft=s.convert(B.type),Ct=_(B.internalFormat,Et,ft,B.colorSpace),Mt=i.get(S),nt=i.get(B);if(nt.__renderTarget=S,!Mt.__hasExternalTextures){const ot=Math.max(1,S.width>>X),Lt=Math.max(1,S.height>>X);et===e.TEXTURE_3D||et===e.TEXTURE_2D_ARRAY?n.texImage3D(et,X,Ct,ot,Lt,S.depth,0,Et,ft,null):n.texImage2D(et,X,Ct,ot,Lt,0,Et,ft,null)}n.bindFramebuffer(e.FRAMEBUFFER,R),yt(S)?o.framebufferTexture2DMultisampleEXT(e.FRAMEBUFFER,K,et,nt.__webglTexture,0,ge(S)):(et===e.TEXTURE_2D||et>=e.TEXTURE_CUBE_MAP_POSITIVE_X&&et<=e.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&e.framebufferTexture2D(e.FRAMEBUFFER,K,et,nt.__webglTexture,X),n.bindFramebuffer(e.FRAMEBUFFER,null)}function zt(R,S,B){if(e.bindRenderbuffer(e.RENDERBUFFER,R),S.depthBuffer){const K=S.depthTexture,et=K&&K.isDepthTexture?K.type:null,X=y(S.stencilBuffer,et),Et=S.stencilBuffer?e.DEPTH_STENCIL_ATTACHMENT:e.DEPTH_ATTACHMENT,ft=ge(S);yt(S)?o.renderbufferStorageMultisampleEXT(e.RENDERBUFFER,ft,X,S.width,S.height):B?e.renderbufferStorageMultisample(e.RENDERBUFFER,ft,X,S.width,S.height):e.renderbufferStorage(e.RENDERBUFFER,X,S.width,S.height),e.framebufferRenderbuffer(e.FRAMEBUFFER,Et,e.RENDERBUFFER,R)}else{const K=S.textures;for(let et=0;et<K.length;et++){const X=K[et],Et=s.convert(X.format,X.colorSpace),ft=s.convert(X.type),Ct=_(X.internalFormat,Et,ft,X.colorSpace),Mt=ge(S);B&&yt(S)===!1?e.renderbufferStorageMultisample(e.RENDERBUFFER,Mt,Ct,S.width,S.height):yt(S)?o.renderbufferStorageMultisampleEXT(e.RENDERBUFFER,Mt,Ct,S.width,S.height):e.renderbufferStorage(e.RENDERBUFFER,Ct,S.width,S.height)}}e.bindRenderbuffer(e.RENDERBUFFER,null)}function Tt(R,S){if(S&&S.isWebGLCubeRenderTarget)throw new Error("Depth Texture with cube render targets is not supported");if(n.bindFramebuffer(e.FRAMEBUFFER,R),!(S.depthTexture&&S.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");const K=i.get(S.depthTexture);K.__renderTarget=S,(!K.__webglTexture||S.depthTexture.image.width!==S.width||S.depthTexture.image.height!==S.height)&&(S.depthTexture.image.width=S.width,S.depthTexture.image.height=S.height,S.depthTexture.needsUpdate=!0),Y(S.depthTexture,0);const et=K.__webglTexture,X=ge(S);if(S.depthTexture.format===Xo)yt(S)?o.framebufferTexture2DMultisampleEXT(e.FRAMEBUFFER,e.DEPTH_ATTACHMENT,e.TEXTURE_2D,et,0,X):e.framebufferTexture2D(e.FRAMEBUFFER,e.DEPTH_ATTACHMENT,e.TEXTURE_2D,et,0);else if(S.depthTexture.format===Wo)yt(S)?o.framebufferTexture2DMultisampleEXT(e.FRAMEBUFFER,e.DEPTH_STENCIL_ATTACHMENT,e.TEXTURE_2D,et,0,X):e.framebufferTexture2D(e.FRAMEBUFFER,e.DEPTH_STENCIL_ATTACHMENT,e.TEXTURE_2D,et,0);else throw new Error("Unknown depthTexture format")}function Kt(R){const S=i.get(R),B=R.isWebGLCubeRenderTarget===!0;if(S.__boundDepthTexture!==R.depthTexture){const K=R.depthTexture;if(S.__depthDisposeCallback&&S.__depthDisposeCallback(),K){const et=()=>{delete S.__boundDepthTexture,delete S.__depthDisposeCallback,K.removeEventListener("dispose",et)};K.addEventListener("dispose",et),S.__depthDisposeCallback=et}S.__boundDepthTexture=K}if(R.depthTexture&&!S.__autoAllocateDepthBuffer){if(B)throw new Error("target.depthTexture not supported in Cube render targets");const K=R.texture.mipmaps;K&&K.length>0?Tt(S.__webglFramebuffer[0],R):Tt(S.__webglFramebuffer,R)}else if(B){S.__webglDepthbuffer=[];for(let K=0;K<6;K++)if(n.bindFramebuffer(e.FRAMEBUFFER,S.__webglFramebuffer[K]),S.__webglDepthbuffer[K]===void 0)S.__webglDepthbuffer[K]=e.createRenderbuffer(),zt(S.__webglDepthbuffer[K],R,!1);else{const et=R.stencilBuffer?e.DEPTH_STENCIL_ATTACHMENT:e.DEPTH_ATTACHMENT,X=S.__webglDepthbuffer[K];e.bindRenderbuffer(e.RENDERBUFFER,X),e.framebufferRenderbuffer(e.FRAMEBUFFER,et,e.RENDERBUFFER,X)}}else{const K=R.texture.mipmaps;if(K&&K.length>0?n.bindFramebuffer(e.FRAMEBUFFER,S.__webglFramebuffer[0]):n.bindFramebuffer(e.FRAMEBUFFER,S.__webglFramebuffer),S.__webglDepthbuffer===void 0)S.__webglDepthbuffer=e.createRenderbuffer(),zt(S.__webglDepthbuffer,R,!1);else{const et=R.stencilBuffer?e.DEPTH_STENCIL_ATTACHMENT:e.DEPTH_ATTACHMENT,X=S.__webglDepthbuffer;e.bindRenderbuffer(e.RENDERBUFFER,X),e.framebufferRenderbuffer(e.FRAMEBUFFER,et,e.RENDERBUFFER,X)}}n.bindFramebuffer(e.FRAMEBUFFER,null)}function Je(R,S,B){const K=i.get(R);S!==void 0&&dt(K.__webglFramebuffer,R,R.texture,e.COLOR_ATTACHMENT0,e.TEXTURE_2D,0),B!==void 0&&Kt(R)}function qt(R){const S=R.texture,B=i.get(R),K=i.get(S);R.addEventListener("dispose",A);const et=R.textures,X=R.isWebGLCubeRenderTarget===!0,Et=et.length>1;if(Et||(K.__webglTexture===void 0&&(K.__webglTexture=e.createTexture()),K.__version=S.version,r.memory.textures++),X){B.__webglFramebuffer=[];for(let ft=0;ft<6;ft++)if(S.mipmaps&&S.mipmaps.length>0){B.__webglFramebuffer[ft]=[];for(let Ct=0;Ct<S.mipmaps.length;Ct++)B.__webglFramebuffer[ft][Ct]=e.createFramebuffer()}else B.__webglFramebuffer[ft]=e.createFramebuffer()}else{if(S.mipmaps&&S.mipmaps.length>0){B.__webglFramebuffer=[];for(let ft=0;ft<S.mipmaps.length;ft++)B.__webglFramebuffer[ft]=e.createFramebuffer()}else B.__webglFramebuffer=e.createFramebuffer();if(Et)for(let ft=0,Ct=et.length;ft<Ct;ft++){const Mt=i.get(et[ft]);Mt.__webglTexture===void 0&&(Mt.__webglTexture=e.createTexture(),r.memory.textures++)}if(R.samples>0&&yt(R)===!1){B.__webglMultisampledFramebuffer=e.createFramebuffer(),B.__webglColorRenderbuffer=[],n.bindFramebuffer(e.FRAMEBUFFER,B.__webglMultisampledFramebuffer);for(let ft=0;ft<et.length;ft++){const Ct=et[ft];B.__webglColorRenderbuffer[ft]=e.createRenderbuffer(),e.bindRenderbuffer(e.RENDERBUFFER,B.__webglColorRenderbuffer[ft]);const Mt=s.convert(Ct.format,Ct.colorSpace),nt=s.convert(Ct.type),ot=_(Ct.internalFormat,Mt,nt,Ct.colorSpace,R.isXRRenderTarget===!0),Lt=ge(R);e.renderbufferStorageMultisample(e.RENDERBUFFER,Lt,ot,R.width,R.height),e.framebufferRenderbuffer(e.FRAMEBUFFER,e.COLOR_ATTACHMENT0+ft,e.RENDERBUFFER,B.__webglColorRenderbuffer[ft])}e.bindRenderbuffer(e.RENDERBUFFER,null),R.depthBuffer&&(B.__webglDepthRenderbuffer=e.createRenderbuffer(),zt(B.__webglDepthRenderbuffer,R,!0)),n.bindFramebuffer(e.FRAMEBUFFER,null)}}if(X){n.bindTexture(e.TEXTURE_CUBE_MAP,K.__webglTexture),at(e.TEXTURE_CUBE_MAP,S);for(let ft=0;ft<6;ft++)if(S.mipmaps&&S.mipmaps.length>0)for(let Ct=0;Ct<S.mipmaps.length;Ct++)dt(B.__webglFramebuffer[ft][Ct],R,S,e.COLOR_ATTACHMENT0,e.TEXTURE_CUBE_MAP_POSITIVE_X+ft,Ct);else dt(B.__webglFramebuffer[ft],R,S,e.COLOR_ATTACHMENT0,e.TEXTURE_CUBE_MAP_POSITIVE_X+ft,0);x(S)&&u(e.TEXTURE_CUBE_MAP),n.unbindTexture()}else if(Et){for(let ft=0,Ct=et.length;ft<Ct;ft++){const Mt=et[ft],nt=i.get(Mt);let ot=e.TEXTURE_2D;(R.isWebGL3DRenderTarget||R.isWebGLArrayRenderTarget)&&(ot=R.isWebGL3DRenderTarget?e.TEXTURE_3D:e.TEXTURE_2D_ARRAY),n.bindTexture(ot,nt.__webglTexture),at(ot,Mt),dt(B.__webglFramebuffer,R,Mt,e.COLOR_ATTACHMENT0+ft,ot,0),x(Mt)&&u(ot)}n.unbindTexture()}else{let ft=e.TEXTURE_2D;if((R.isWebGL3DRenderTarget||R.isWebGLArrayRenderTarget)&&(ft=R.isWebGL3DRenderTarget?e.TEXTURE_3D:e.TEXTURE_2D_ARRAY),n.bindTexture(ft,K.__webglTexture),at(ft,S),S.mipmaps&&S.mipmaps.length>0)for(let Ct=0;Ct<S.mipmaps.length;Ct++)dt(B.__webglFramebuffer[Ct],R,S,e.COLOR_ATTACHMENT0,ft,Ct);else dt(B.__webglFramebuffer,R,S,e.COLOR_ATTACHMENT0,ft,0);x(S)&&u(ft),n.unbindTexture()}R.depthBuffer&&Kt(R)}function Ee(R){const S=R.textures;for(let B=0,K=S.length;B<K;B++){const et=S[B];if(x(et)){const X=g(R),Et=i.get(et).__webglTexture;n.bindTexture(X,Et),u(X),n.unbindTexture()}}}const w=[],Qt=[];function Jt(R){if(R.samples>0){if(yt(R)===!1){const S=R.textures,B=R.width,K=R.height;let et=e.COLOR_BUFFER_BIT;const X=R.stencilBuffer?e.DEPTH_STENCIL_ATTACHMENT:e.DEPTH_ATTACHMENT,Et=i.get(R),ft=S.length>1;if(ft)for(let Mt=0;Mt<S.length;Mt++)n.bindFramebuffer(e.FRAMEBUFFER,Et.__webglMultisampledFramebuffer),e.framebufferRenderbuffer(e.FRAMEBUFFER,e.COLOR_ATTACHMENT0+Mt,e.RENDERBUFFER,null),n.bindFramebuffer(e.FRAMEBUFFER,Et.__webglFramebuffer),e.framebufferTexture2D(e.DRAW_FRAMEBUFFER,e.COLOR_ATTACHMENT0+Mt,e.TEXTURE_2D,null,0);n.bindFramebuffer(e.READ_FRAMEBUFFER,Et.__webglMultisampledFramebuffer);const Ct=R.texture.mipmaps;Ct&&Ct.length>0?n.bindFramebuffer(e.DRAW_FRAMEBUFFER,Et.__webglFramebuffer[0]):n.bindFramebuffer(e.DRAW_FRAMEBUFFER,Et.__webglFramebuffer);for(let Mt=0;Mt<S.length;Mt++){if(R.resolveDepthBuffer&&(R.depthBuffer&&(et|=e.DEPTH_BUFFER_BIT),R.stencilBuffer&&R.resolveStencilBuffer&&(et|=e.STENCIL_BUFFER_BIT)),ft){e.framebufferRenderbuffer(e.READ_FRAMEBUFFER,e.COLOR_ATTACHMENT0,e.RENDERBUFFER,Et.__webglColorRenderbuffer[Mt]);const nt=i.get(S[Mt]).__webglTexture;e.framebufferTexture2D(e.DRAW_FRAMEBUFFER,e.COLOR_ATTACHMENT0,e.TEXTURE_2D,nt,0)}e.blitFramebuffer(0,0,B,K,0,0,B,K,et,e.NEAREST),l===!0&&(w.length=0,Qt.length=0,w.push(e.COLOR_ATTACHMENT0+Mt),R.depthBuffer&&R.resolveDepthBuffer===!1&&(w.push(X),Qt.push(X),e.invalidateFramebuffer(e.DRAW_FRAMEBUFFER,Qt)),e.invalidateFramebuffer(e.READ_FRAMEBUFFER,w))}if(n.bindFramebuffer(e.READ_FRAMEBUFFER,null),n.bindFramebuffer(e.DRAW_FRAMEBUFFER,null),ft)for(let Mt=0;Mt<S.length;Mt++){n.bindFramebuffer(e.FRAMEBUFFER,Et.__webglMultisampledFramebuffer),e.framebufferRenderbuffer(e.FRAMEBUFFER,e.COLOR_ATTACHMENT0+Mt,e.RENDERBUFFER,Et.__webglColorRenderbuffer[Mt]);const nt=i.get(S[Mt]).__webglTexture;n.bindFramebuffer(e.FRAMEBUFFER,Et.__webglFramebuffer),e.framebufferTexture2D(e.DRAW_FRAMEBUFFER,e.COLOR_ATTACHMENT0+Mt,e.TEXTURE_2D,nt,0)}n.bindFramebuffer(e.DRAW_FRAMEBUFFER,Et.__webglMultisampledFramebuffer)}else if(R.depthBuffer&&R.resolveDepthBuffer===!1&&l){const S=R.stencilBuffer?e.DEPTH_STENCIL_ATTACHMENT:e.DEPTH_ATTACHMENT;e.invalidateFramebuffer(e.DRAW_FRAMEBUFFER,[S])}}}function ge(R){return Math.min(a.maxSamples,R.samples)}function yt(R){const S=i.get(R);return R.samples>0&&t.has("WEBGL_multisampled_render_to_texture")===!0&&S.__useRenderToTexture!==!1}function Ae(R){const S=r.render.frame;f.get(R)!==S&&(f.set(R,S),R.update())}function Rt(R,S){const B=R.colorSpace,K=R.format,et=R.type;return R.isCompressedTexture===!0||R.isVideoTexture===!0||B!==wr&&B!==_a&&(ie.getTransfer(B)===fe?(K!==fi||et!==ea)&&Ft("WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):Oe("WebGLTextures: Unsupported texture color space:",B)),S}function Ht(R){return typeof HTMLImageElement<"u"&&R instanceof HTMLImageElement?(c.width=R.naturalWidth||R.width,c.height=R.naturalHeight||R.height):typeof VideoFrame<"u"&&R instanceof VideoFrame?(c.width=R.displayWidth,c.height=R.displayHeight):(c.width=R.width,c.height=R.height),c}this.allocateTextureUnit=k,this.resetTextureUnits=I,this.setTexture2D=Y,this.setTexture2DArray=N,this.setTexture3D=H,this.setTextureCube=F,this.rebindTextures=Je,this.setupRenderTarget=qt,this.updateRenderTargetMipmap=Ee,this.updateMultisampleRenderTarget=Jt,this.setupDepthRenderbuffer=Kt,this.setupFrameBufferTexture=dt,this.useMultisampledRTT=yt}function mR(e,t){function n(i,a=_a){let s;const r=ie.getTransfer(a);if(i===ea)return e.UNSIGNED_BYTE;if(i===Dp)return e.UNSIGNED_SHORT_4_4_4_4;if(i===Up)return e.UNSIGNED_SHORT_5_5_5_1;if(i===jv)return e.UNSIGNED_INT_5_9_9_9_REV;if(i===Zv)return e.UNSIGNED_INT_10F_11F_11F_REV;if(i===Yv)return e.BYTE;if(i===qv)return e.SHORT;if(i===Vo)return e.UNSIGNED_SHORT;if(i===wp)return e.INT;if(i===ms)return e.UNSIGNED_INT;if(i===Xi)return e.FLOAT;if(i===Gr)return e.HALF_FLOAT;if(i===Kv)return e.ALPHA;if(i===Qv)return e.RGB;if(i===fi)return e.RGBA;if(i===Xo)return e.DEPTH_COMPONENT;if(i===Wo)return e.DEPTH_STENCIL;if(i===Jv)return e.RED;if(i===Lp)return e.RED_INTEGER;if(i===Np)return e.RG;if(i===Op)return e.RG_INTEGER;if(i===Pp)return e.RGBA_INTEGER;if(i===pc||i===mc||i===xc||i===gc)if(r===fe)if(s=t.get("WEBGL_compressed_texture_s3tc_srgb"),s!==null){if(i===pc)return s.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(i===mc)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(i===xc)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(i===gc)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(s=t.get("WEBGL_compressed_texture_s3tc"),s!==null){if(i===pc)return s.COMPRESSED_RGB_S3TC_DXT1_EXT;if(i===mc)return s.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(i===xc)return s.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(i===gc)return s.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(i===Qh||i===Jh||i===$h||i===td)if(s=t.get("WEBGL_compressed_texture_pvrtc"),s!==null){if(i===Qh)return s.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(i===Jh)return s.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(i===$h)return s.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(i===td)return s.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(i===ed||i===nd||i===id)if(s=t.get("WEBGL_compressed_texture_etc"),s!==null){if(i===ed||i===nd)return r===fe?s.COMPRESSED_SRGB8_ETC2:s.COMPRESSED_RGB8_ETC2;if(i===id)return r===fe?s.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:s.COMPRESSED_RGBA8_ETC2_EAC}else return null;if(i===ad||i===sd||i===rd||i===od||i===ld||i===cd||i===ud||i===fd||i===hd||i===dd||i===pd||i===md||i===xd||i===gd)if(s=t.get("WEBGL_compressed_texture_astc"),s!==null){if(i===ad)return r===fe?s.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:s.COMPRESSED_RGBA_ASTC_4x4_KHR;if(i===sd)return r===fe?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:s.COMPRESSED_RGBA_ASTC_5x4_KHR;if(i===rd)return r===fe?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:s.COMPRESSED_RGBA_ASTC_5x5_KHR;if(i===od)return r===fe?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:s.COMPRESSED_RGBA_ASTC_6x5_KHR;if(i===ld)return r===fe?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:s.COMPRESSED_RGBA_ASTC_6x6_KHR;if(i===cd)return r===fe?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:s.COMPRESSED_RGBA_ASTC_8x5_KHR;if(i===ud)return r===fe?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:s.COMPRESSED_RGBA_ASTC_8x6_KHR;if(i===fd)return r===fe?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:s.COMPRESSED_RGBA_ASTC_8x8_KHR;if(i===hd)return r===fe?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:s.COMPRESSED_RGBA_ASTC_10x5_KHR;if(i===dd)return r===fe?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:s.COMPRESSED_RGBA_ASTC_10x6_KHR;if(i===pd)return r===fe?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:s.COMPRESSED_RGBA_ASTC_10x8_KHR;if(i===md)return r===fe?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:s.COMPRESSED_RGBA_ASTC_10x10_KHR;if(i===xd)return r===fe?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:s.COMPRESSED_RGBA_ASTC_12x10_KHR;if(i===gd)return r===fe?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:s.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(i===_d||i===vd||i===Sd)if(s=t.get("EXT_texture_compression_bptc"),s!==null){if(i===_d)return r===fe?s.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:s.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(i===vd)return s.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(i===Sd)return s.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(i===yd||i===Md||i===bd||i===Ed)if(s=t.get("EXT_texture_compression_rgtc"),s!==null){if(i===yd)return s.COMPRESSED_RED_RGTC1_EXT;if(i===Md)return s.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(i===bd)return s.COMPRESSED_RED_GREEN_RGTC2_EXT;if(i===Ed)return s.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return i===ko?e.UNSIGNED_INT_24_8:e[i]!==void 0?e[i]:null}return{convert:n}}const xR=`
void main() {
